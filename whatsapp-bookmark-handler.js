...
const BOOKMARK_API_URL = process.env.BOOKMARK_API_URL || 'https://bookmark-manager-beryl.vercel.app'
const BOOKMARK_API_KEY = process.env.BOOKMARK_API_KEY || 'bookmark-clawdbot-api-key-2026-secure1757'
